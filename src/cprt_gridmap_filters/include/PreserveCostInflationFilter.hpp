...
public:
   ...
   */
  void computeWithSimpleSerialMethod(const grid_map::GridMap &mapIn, grid_map::GridMap &mapOut);

  void radialInflateSerial(grid_map::GridMap &mapOut, const Eigen::Vector2d &position, const float value);
