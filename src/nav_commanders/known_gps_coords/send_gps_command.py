...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Send GPS coordinates to ROS2 service.")
    group = parser.add_mutually_exclusive_group(required=True)
    group.add_argument("--file", type=str, help="YAML file containing GPS coordinates (lat, lon).")
