...
class JoystickController(Node):
    ...
    def __init__(self):
        ...
        linear_axis = self.get_parameter("linear_axis_index").int_value
        self.declare_parameter("turn_axis_index", 1)
        turn_axis = self.get_parameter("turn_axis_index").int_value
        ...
        self.turbo_multiplier = self.get_parameter("turbo_multiplier").double_value
        self.declare_parameter("curve_type", "linear")
        curve_type = self.get_parameter("curve_type").string_value
