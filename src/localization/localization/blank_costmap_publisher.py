...
class BlankMapPublisher(Node):
    ...
    def publish_map(self):
        ...
        map_width_meters = 100.0  # Total width of the map in meters
        map_height_meters = 100.0  # Total height of the map in meters
        ...
        map_msg.data = array.array("b", [1] * map_data_size)
