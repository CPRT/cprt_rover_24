...
class RunRoboflowModel:

    def __init__(self, model_id, output_path, live_device, im_show, input_file):
        ...
        self.pipeline = InferencePipeline.init(
            model_id=model_id, # set the model id to a yolov8x model with in put size 1280
